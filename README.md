...
```
bash <(curl -sL https://raw.githubusercontent.com/dead-man1/reality-ezpz/master/reality-ezpz.sh)
```
...
```
bash <(curl -sL https://raw.githubusercontent.com/dead-man1/reality-ezpz/master/reality-ezpz.sh) -m
```
